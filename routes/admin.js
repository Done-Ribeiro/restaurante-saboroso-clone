...
//! agora, ele é uma fn, que recebe o io, e vai retornar o router
module.exports = function (io) {
  /**
   * ! pra usar o io, nos meus arquivos (users, reservations, ...), preciso colocar todo o conteudo dentro desta fn
   * * agora, tenho acesso ao io, dentro das minhas rotas
  */
  moment.locale('pt-BR');
  ...
  router.delete('/contacts/:id', function (req, res, next) {
    contacts.delete(req.params.id).then(results => {
      io.emit('dashboard update');// io - emite o evento -> dashboard update, quando deletar um contato / atualiza o dashboard
      res.send(results);
    }).catch(err => {
      res.send(err);
    });
